...
class LifeTextStyles extends ThemeExtension<LifeTextStyles> {
  ...
  factory LifeTextStyles.standard() {
    return const LifeTextStyles(
      display: TextStyle(
        fontFamily: LifeFontFamily.display,
        fontSize: 34,
        height: 40 / 34,
      ...
      title3: TextStyle(
        fontFamily: LifeFontFamily.body,
        fontSize: 18,
        height: 24 / 18,
        fontWeight: FontWeight.w600,
      ),
      ...
      mono: TextStyle(
        fontFamily: LifeFontFamily.mono,
        fontSize: 13,
        height: 18 / 13,
        fontWeight: FontWeight.w500,
